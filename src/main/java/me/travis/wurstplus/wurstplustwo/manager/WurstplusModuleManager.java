...
import me.travis.wurstplus.wurstplustwo.hacks.movement.WurstplusBurrow;
...
public class WurstplusModuleManager {
	...
	public WurstplusModuleManager() {
		...
		add_hack(new WurstplusAutoCope());
		...
		add_hack(new WurstplusNoSlow());
		add_hack(new WurstplusSpeed());
		add_hack(new WurstplusInventoryWalk());
		...
		add_hack(new WurstplusOldHit());
		add_hack(new WurstplusRichPresence());
